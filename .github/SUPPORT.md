# Getting help with pmdplyr

Thanks for using pmdplyr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/pmdplyr/issues) to make sure the 
